...
use microbit::{board::Board, hal::{gpio::{Level, DriveConfig}, Delay, Timer}};
...
fn main() -> ! {
    ...
    let mut ws2812 = Ws2812::new(delay, pin);
    ...
    loop {
        <Ws2812<_, _> as SmartLedsWrite>::write(&mut ws2812, leds.into_iter()).unwrap();
        timer.delay_ms(500);
    }
}
